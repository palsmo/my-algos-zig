...
pub fn build(b: *std.Build) void {
    ...
    const dep_bamboo_structs = b.dependency("bamboo_structs", .{
        .target = target,
        .optimize = optimize,
    }).module("root");
    ...
    mod_pub_root.addImport("bamboo_structs", dep_bamboo_structs);
    ...
    if (op_file_path) |path| {
        ...
        test_file.root_module.addImport("bamboo_structs", dep_bamboo_structs);
